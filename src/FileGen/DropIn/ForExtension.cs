...
internal static partial class ZLinqDropInExtensions
{
 ...
 => source.AsValueEnumerable().UnionBy(second, keySelector, comparer);
    ...
    public static ValueEnumerable<WhereArray<TSource>, TSource> Where<TSource>(this TSource[] source, Func<TSource, Boolean> predicate) => source.AsValueEnumerable().Where(predicate);
