...
namespace ZLinq.Tests
{
    public class MaxTests : EnumerableTests
    {
        public static IEnumerable<object[]> Max_AllTypes_TestData()
        {
            ...
            {
                yield return new object[] { Enumerable.Select(Shuffler.Shuffle(Enumerable.Range(length, length)), i => (byte)i), (byte)(length + length - 1) };
                ...
                {
                    yield return new object[] { Enumerable.Select(Shuffler.Shuffle(Enumerable.Range(length, length)), i => (sbyte)i), (sbyte)(length + length - 1) };
                    yield return new object[] { Shuffler.Shuffle(Enumerable.Range(length, length).Select(i => (sbyte)i).ToArray()), (sbyte)(length + length - 1) };
                }

                yield return new object[] { Enumerable.Select(Shuffler.Shuffle(Enumerable.Range(length, length)), i => (ushort)i), (ushort)(length + length - 1) };
                yield return new object[] { Shuffler.Shuffle(Enumerable.Range(length, length).Select(i => (ushort)i).ToArray()), (ushort)(length + length - 1) };

                yield return new object[] { Enumerable.Select(Shuffler.Shuffle(Enumerable.Range(length, length)), i => (short)i), (short)(length + length - 1) };
                yield return new object[] { Shuffler.Shuffle(Enumerable.Range(length, length).Select(i => (short)i).ToArray()), (short)(length + length - 1) };

                yield return new object[] { Enumerable.Select(Shuffler.Shuffle(Enumerable.Range(length, length)), i => (char)i), (char)(length + length - 1) };
                yield return new object[] { Shuffler.Shuffle(Enumerable.Range(length, length).Select(i => (char)i).ToArray()), (char)(length + length - 1) };

                yield return new object[] { Enumerable.Select(Shuffler.Shuffle(Enumerable.Range(length, length)), i => (uint)i), (uint)(length + length - 1) };
                yield return new object[] { Shuffler.Shuffle(Enumerable.Range(length, length).Select(i => (uint)i).ToArray()), (uint)(length + length - 1) };

                yield return new object[] { Enumerable.Select(Shuffler.Shuffle(Enumerable.Range(length, length)), i => (int)i), (int)(length + length - 1) };
                yield return new object[] { Shuffler.Shuffle(Enumerable.Range(length, length).Select(i => (int)i).ToArray()), (int)(length + length - 1) };

                yield return new object[] { Enumerable.Select(Shuffler.Shuffle(Enumerable.Range(length, length)), i => (ulong)i), (ulong)(length + length - 1) };
                yield return new object[] { Shuffler.Shuffle(Enumerable.Range(length, length).Select(i => (ulong)i).ToArray()), (ulong)(length + length - 1) };

                yield return new object[] { Enumerable.Select(Shuffler.Shuffle(Enumerable.Range(length, length)), i => (long)i), (long)(length + length - 1) };
                yield return new object[] { Shuffler.Shuffle(Enumerable.Range(length, length).Select(i => (long)i).ToArray()), (long)(length + length - 1) };

                yield return new object[] { Enumerable.Select(Shuffler.Shuffle(Enumerable.Range(length, length)), i => (float)i), (float)(length + length - 1) };
                yield return new object[] { Shuffler.Shuffle(Enumerable.Range(length, length).Select(i => (float)i).ToArray()), (float)(length + length - 1) };

                yield return new object[] { Enumerable.Select(Shuffler.Shuffle(Enumerable.Range(length, length)), i => (double)i), (double)(length + length - 1) };
                yield return new object[] { Shuffler.Shuffle(Enumerable.Range(length, length).Select(i => (double)i).ToArray()), (double)(length + length - 1) };

                yield return new object[] { Enumerable.Select(Shuffler.Shuffle(Enumerable.Range(length, length)), i => (decimal)i), (decimal)(length + length - 1) };
                ...
                yield return new object[] { Enumerable.Select(Shuffler.Shuffle(Enumerable.Range(length, length)), i => (nuint)i), (nuint)(length + length - 1) };
                yield return new object[] { Shuffler.Shuffle(Enumerable.Range(length, length).Select(i => (nuint)i).ToArray()), (nuint)(length + length - 1) };

                yield return new object[] { Enumerable.Select(Shuffler.Shuffle(Enumerable.Range(length, length)), i => (nint)i), (nint)(length + length - 1) };
                yield return new object[] { Shuffler.Shuffle(Enumerable.Range(length, length).Select(i => (nint)i).ToArray()), (nint)(length + length - 1) };

                yield return new object[] { Enumerable.Select(Shuffler.Shuffle(Enumerable.Range(length, length)), i => (Int128)i), (Int128)(length + length - 1) };
                yield return new object[] { Shuffler.Shuffle(Enumerable.Range(length, length).Select(i => (Int128)i).ToArray()), (Int128)(length + length - 1) };

                yield return new object[] { Enumerable.Select(Shuffler.Shuffle(Enumerable.Range(length, length)), i => (UInt128)i), (UInt128)(length + length - 1) };
